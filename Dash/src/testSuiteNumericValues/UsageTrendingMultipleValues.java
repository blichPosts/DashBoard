...
public class UsageTrendingMultipleValues extends BaseClass {
	...
	public static void UsageTrendingMultipleValuesTest() throws Exception {
		...
		// #3 Some vendors might not have information for all last 13 months; in
		// that case the value displayed on the Trending chart is zero
		// So to have a valid value to compare with, the info for those missing
		// months (on source file) is created and values are set to zero.
		...
		// #4 Each list in dataForExpenseTrending will have the data for a
		// specific month, for all the vendors previously selected
